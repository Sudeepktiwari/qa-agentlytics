...
export default function ProactiveAIPage() {
  ...
  return (
    ...
    >
      ...
      {/* Page-specific menu — dual headers: sticky below global, floating at top */}
      <div>
        {/* Desktop page-specific header that sits below GlobalHeader, then fades out */}
        <header
          className={`${scrolled ? "top-0" : "top-16"} fixed left-0 right-0 z-40 bg-white/80 backdrop-blur border-b border-slate-200 transition-[top,opacity,transform] duration-300 ease-out hidden md:block ${
            floating
        ...
        {/* Desktop floating bar — appears at very top once scrolled */}
        <header
        ...
        {/* Mobile header — simple sticky under GlobalHeader */}
        <header className="sticky top-0 z-10 bg-white/80 backdrop-blur border-b border-slate-200 md:hidden">
          ...
          <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-20">
            <div className="reveal">
              ...
              <p className="mt-5 max-w-xl text-lg text-slate-600">
                ...
                Proactive AI Agent detects intent from scroll depth,
                pricing-page dwell, and exit patterns — then starts the right
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 md:p-6 shadow-sm transition hover:shadow-md">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Sits idle, lacks context, and responds only after the user
                types.
              </p>
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 max-w-md text-slate-600">
                Watch how behavior signals trigger targeted prompts that
                convert. No code required to get started — just drop-in and go.
              </p>
        ...
        <section
          id="faq"
          className="mx-auto max-w-7xl px-4 py-16 sm:px-6 reveal"
        >
          <h2 className="text-balance text-3xl font-bold tracking-tight">
            FAQ
          </h2>
