    ...
    <div className="scroll-smooth">
      ...
      <main className="max-w-5xl mx-auto px-4 py-12">
        <section id="integration" className="scroll-mt-24">
          <h1 className="text-3xl font-bold text-slate-900">Agentlytics + Intercom</h1>
          <p className="mt-4 text-slate-700">
            Connect Agentlytics with Intercom to enrich conversations, sync context, and analyze support outcomes.
          </p>
        </section>
        <section id="setup" className="scroll-mt-24 mt-12">
          ...
          <ul className="mt-4 list-disc list-inside text-slate-700">
            <li>Generate Intercom access token and store securely.</li>
            <li>Enable webhook events for conversation updates.</li>
            <li>Map Intercom user attributes to Agentlytics fields.</li>
          </ul>
        </section>
        <section id="analytics" className="scroll-mt-24 mt-12">
          <h2 className="text-2xl font-semibold text-slate-900">Analytics</h2>
          <p className="mt-4 text-slate-700">Track resolution time, CSAT, and automation assist rates.</p>
        </section>
        <section id="faq" className="scroll-mt-24 mt-12">
          <h2 className="text-2xl font-semibold text-slate-900">FAQ</h2>
          <p className="mt-4 text-slate-700">Common questions about authentication, rate limits, and data scopes.</p>
        </section>
      </main>
    </div>
  );
