        ...
        <div className="mt-6 overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-sm">
          <div className="aspect-video w-full bg-gradient-to-br from-blue-50 to-white">
            <div className="flex h-full w-full items-center justify-center p-6 text-center">
              <div>
                <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-medium text-blue-700">
                  Video placeholder
                </div>
                ...
                <p className="mt-2 max-w-md text-sm text-slate-600">
                  Example: YouTube/Vimeo iframe, or your custom player. The page
                  content starts below this video.
                </p>
              </div>
            </div>
          </div>
