              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 lg:col-span-2">
                ...
                {crawledPages.length === 0 ? (
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="w-full lg:w-1/3 border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div className="w-full lg:flex-1 border border-gray-200 rounded-lg overflow-hidden">
